...
const DocsPage = (props: Props) => {
    ...
    return (
        <>
            <div className="docsPage flex flex-row justify-start items-start bg-gradient-to-br from-gray-900 to-black">
                {/* Sidebar Section */}
                <div className="flex flex-col justify-start items-start overflow-x-hidden ml-8 mt-0 h-[170vh] p-2 pr-12 border-r-[0.5px] border-r-gray-700">
                ...
                <div className="flex flex-col justify-start items-start ml-8 mt-8 w-full">
                    <h1 className="text-3xl font-bold mb-4">Welcome to Code Leveling</h1>
                        ...
                        {features.map((feature, index) => (
                            ...
                            >
                                ...
                                {feature === 'How to level up?' && (
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-4">How to Level Up?</h2>
                                        <p className="text-gray-700">
                                ...
                                {feature === 'Shop - how to redeem' && (
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-4">Shop - How to Redeem</h2>
                                        <p className="text-gray-700">
                                ...
                                {feature === 'Shoutouts' && (
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-4">Shoutouts</h2>
                                        <p className="text-gray-700">
