...
const ThemeToggleBtn = () => {
  ...
  return (
    <div className="themeToggleBtn flex items-center justify-center relative left-60 bottom-60 dark:bg-[#18191c] bg-white px-3 py-2 outline-none border-none rounded-3xl">
      <button
        onClick={toggleTheme}
