...
const ThemeToggleBtn = () => {
    ...
    return (
        <div className="themeToggleBtn flex items-center justify-center relative dark:bg-[#18191c] bg-slate-200 px-3 py-2 outline-none border-none rounded-3xl w-20 h-10 top-20">
            <button
                onClick={toggleTheme}
            ...
            >
                <span
                    className={`inline-block h-6 w-6 transform rounded-full shadow-md transition-transform ${isDarkMode ? 'translate-x-6 bg-yellow-400' : 'bg-gray-900'
                        }`}
                >
                    {isDarkMode ? (
                        <svg
