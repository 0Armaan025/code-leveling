            ...
            <div className="wrapperDivForXCard">
                <div className="xCard flex flex-col bg-slate-200 dark:bg-gradient-to-r dark:from-[#18181c] dark:via-[#090212] dark:to-[#080112] z-[0] justify-start items-start p-2 rounded-xl relative md:right-12 w-[23rem] hover:cursor-pointer">
                    ...
                    <div className="flex flex-col mt-3 justify-start items-start w-72">
                        <h2 className='ml-1 text-[#71717a] text-sm dark:text-[#d1d5db]' style={{ fontFamily: "Montserrat, serif" }}>Full stack | NextJS | Flutter | @code-leveling dev, he/his/him 🔥</h2>
                    </div>

                    {/* second text section */}
                    <div className="flex flex-col mt-3 justify-start items-start w-72">
                        <h2 className='ml-1 text-[#71717a] text-sm dark:text-[#d1d5db]' style={{ fontFamily: "Montserrat, serif" }}><span className='font-semibold'>317</span> Following | <span className='font-semibold'>88</span> Followers</h2>
                    </div>
