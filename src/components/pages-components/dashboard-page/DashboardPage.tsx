            ...
            <div className="relative w-full max-w-[1000px] bg-black/90 rounded-xl border-2 border-blue-500/30 shadow-xl p-6 backdrop-blur-xl">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex space-x-3">
                        <select value={selectedTimeRange} onChange={(e) => setSelectedTimeRange(e.target.value)} className="bg-black text-cyan-300 px-3 py-1.5 rounded-lg border border-blue-500">
                            {timeRangeOptions.map((option) => (
                                <option key={option} value={option}>{option}</option>
                            ))}
                        </select>
                        <select value={selectedProject} onChange={(e) => setSelectedProject(e.target.value)} className="bg-black text-cyan-300 px-3 py-1.5 rounded-lg border border-blue-500">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="bg-black p-4 rounded-lg border border-blue-500 col-span-2">
                    ...
                    {/* New Chart 1: Language Usage - BarChart */}
                    <div className="bg-black p-4 rounded-lg border border-blue-500">
                    ...
                    {/* New Chart 2: Language Usage Percentage - PieChart */}
                    <div className="bg-black p-4 rounded-lg border border-blue-500">
