...
const RedeemPageComponent = () => {
    ...
    return (
        <div className="redeemPage min-h-screen p-6 bg-black flex items-center justify-center relative overflow-hidden">
            {/* Animated Background Elements */}
            <div className="absolute inset-0 bg-[url('/grid-pattern.svg')] opacity-10 animate-pulse"></div>
            <div className="absolute inset-0 bg-gradient-to-b from-blue-500/5 to-transparent"></div>

            {/* Main Card */}
            <div className="relative w-[700px] bg-black rounded-2xl border-2 border-blue-500/30 shadow-2xl p-8 backdrop-blur-xl transform perspective-1000">
                ...
                <div className="text-center mb-8 space-y-2">
                    ...
                    <p className="text-sm text-cyan-400/80 font-mono">Authorization Level: [★★★☆☆]</p>
                </div>
                ...
                <div className="space-y-6 mb-8">
                    {/* Redeem Code Field */}
                    <div className="group">
                        <label className="block text-cyan-400/80 text-sm font-mono mb-2 ml-1">
                            REDEEM CODE
                        </label>
                        <div className="relative bg-gradient-to-r from-black/80 to-black/60 p-[2px] rounded-lg hover:from-blue-500/30 hover:to-cyan-500/30 transition-all">
                            <input
                                ...
                                className="w-full px-5 py-3 bg-black/80 rounded-[calc(0.5rem-2px)] text-cyan-300 border border-blue-500/30 focus:border-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 placeholder-gray-500 font-mono transition-all"
                            />
                        </div>
                    </div>
                ...
                <div className="mt-10 text-center text-sm text-cyan-500/50 font-mono">
